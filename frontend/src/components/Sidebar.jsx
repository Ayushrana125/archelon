    ...
    <aside className={`${collapsed ? 'w-14' : 'w-64'} transition-all duration-300 h-screen bg-gray-50 dark:bg-[#171717] border-r border-gray-200 dark:border-gray-700 flex flex-col flex-shrink-0 fixed top-0 left-0 z-20`}>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden px-3 space-y-4 py-2">
        ...
        <button
          ...
          title="Deployments"
          className={`w-full flex items-center gap-2 rounded-lg transition-colors text-sm ${
            mode === 'deployments'
              ? 'bg-gray-200 dark:bg-[#2a2a2a] text-gray-900 dark:text-gray-100'
              : 'hover:bg-gray-100 dark:hover:bg-[#222222] text-gray-600 dark:text-gray-400'
      ...
      <div className="px-3 pb-3 pt-2 border-t border-gray-200 dark:border-gray-700 relative" ref={menuRef}>
        ...
        >
          <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-light" style={{ background: '#00C9B120', color: '#00C9B1' }}>
            {initials}
          </div>
          {!collapsed && (
